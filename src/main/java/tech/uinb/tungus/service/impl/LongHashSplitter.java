...
public class LongHashSplitter extends AbstractSplitter<Long> {
    public LongHashSplitter(TableMeta meta) {
        super(meta);
    }

    @Override
    public TableDetail computeTable(Long key) {
        //hash subarea
        return search(Math.abs(key));
    }
}
