...
//Receipts.MergeToDeductStashToken(token:T::TokenId,fund_owner:T::AccountId,amount:Compact<TokenBalanceOf<T>>,digest:Vec<u8>)
public class FusotaoReceiptsMergeToDeductStashToken extends ExtrinsicCall {
