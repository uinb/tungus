...
public class FusotaoReceiptsHostTokenChangedReader implements ScaleReader<FusotaoReceiptsHostTokenChanged> {
	@Override
	public FusotaoReceiptsHostTokenChanged read(ScaleCodecReader rdr) {
		var result = new FusotaoReceiptsHostTokenChanged();
