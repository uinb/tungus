...
//Receipts.MergeToDeductStash(fund_owner:T::AccountId,amount:Compact<BalanceOf<T>>,digest:Vec<u8>)
public class FusotaoReceiptsMergeToDeductStash extends ExtrinsicCall {
