...
public class FusotaoTokenTokenTransferedReader implements ScaleReader<FusotaoTokenTokenTransfered> {
	@Override
	public FusotaoTokenTokenTransfered read(ScaleCodecReader rdr) {
		var result = new FusotaoTokenTokenTransfered();
